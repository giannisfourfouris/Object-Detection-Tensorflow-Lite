...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final String TF_OD_API_MODEL_FILE = "detectV2TvFinal.tflite";
    public static final String TF_OD_API_LABELS_FILE = "file:///android_asset/labelmapDesk.txt";
    private static final DetectorMode MODE = DetectorMode.TF_OD_API;
    // Minimum detection confidence to track a detection.
    private static final float MINIMUM_CONFIDENCE_TF_OD_API = 0.73f;
                        ...
                        runOnUiThread(
                                ...
                                new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        showMinConfidence(MINIMUM_CONFIDENCE_TF_OD_API*100 + "%");
